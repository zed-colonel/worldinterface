...
use wi_core::id::{trigger_input_node_id, FlowRunId};
...
pub(crate) struct HostInner {
    ...
    pub compiler_config: wi_flowspec::CompilerConfig,
...
impl EmbeddedHost {
    ...
    pub async fn submit_flow(&self, spec: FlowSpec) -> Result<FlowRunId, HostError> {
        ...
        let result =
            wi_flowspec::compile_with_config(&spec, &self.inner.compiler_config, flow_run_id)?;
