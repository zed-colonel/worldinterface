...
use worldinterface_flowspec::id::derive_step_run_id;
use worldinterface_flowspec::payload::StepPayload;
    ...
    match result {
        Ok(output) => {
            ...
            writer
                ...
                .map_err(|e| match e {
                    worldinterface_contextstore::AtomicWriteError::WriteFailed(store_err) => {
                        StepError::ContextStoreError(store_err)
                    }
                    worldinterface_contextstore::AtomicWriteError::CompletionFailed(e) => {
...
mod tests {
    ...
    use worldinterface_core::flowspec::branch::{BranchCondition, ParamRef};
    use worldinterface_core::flowspec::transform::TransformType;
    use worldinterface_core::id::FlowRunId;
    use worldinterface_core::metrics::NoopMetricsRecorder;
    ...
    fn make_step_payload(
        ...
        StepPayload {
            task_type: worldinterface_flowspec::payload::TaskType::Step,
            flow_run_id,
            node_id,
            node_type,
            flow_params: None,
    ...
    fn connector_step_produces_receipt_on_failure() {
        ...
        assert_eq!(receipt.status, worldinterface_core::receipt::ReceiptStatus::Failure);
        assert_eq!(receipt.connector, "delay");
