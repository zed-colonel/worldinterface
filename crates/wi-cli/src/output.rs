...
use wi_host::{FlowRunStatus, FlowRunSummary};
...
fn format_phase(phase: wi_host::FlowPhase) -> &'static str {
    match phase {
        wi_host::FlowPhase::Pending => "Pending",
        wi_host::FlowPhase::Running => "Running",
        wi_host::FlowPhase::Completed => "Completed",
        wi_host::FlowPhase::Failed => "Failed",
        wi_host::FlowPhase::Canceled => "Canceled",
    }
}

fn format_step_phase(phase: wi_host::StepPhase) -> &'static str {
    match phase {
        wi_host::StepPhase::Pending => "Pending",
        wi_host::StepPhase::Running => "Running",
        wi_host::StepPhase::Completed => "Completed",
        wi_host::StepPhase::Failed => "Failed",
        wi_host::StepPhase::Excluded => "Excluded",
    }
}
...
mod tests {
    ...
    use serde_json::json;
    use wi_core::descriptor::ConnectorCategory;
    use wi_core::id::{FlowRunId, NodeId};
    use wi_host::{FlowPhase, FlowRunStatus, StepPhase, StepStatus};
